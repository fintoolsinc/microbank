...
// File Name: model.view.record.js
// Created: 2021-02-28
// Updates: 2021-02-28
...
async function saveForm(clas){
    ...
    loadSearchAccordion(clas,mid,2,'Model Views');
...
async function loadCombos(clas) {
    let clase = await getCollectionPair('view','id','desc');
                await fillSelect(clase,'model.view.view.id');
}
//------------------------------------------------------//
//Level 3
