...
// File Name: view.record.search.js
// Created: 2021-02-28
// Updates: 2021-02-28
...
//LEVEL 0
( async function() {
    processPage('view.record');
})();
//-------------------------------------------------------//
//LEVEL 1
async function processPage(clas){
    let data = {'tab':clas,'clas':clas,'sflds':'id','svals':component[clas].mid,'buttons':'edit,delete','foot':'no','hiddenCols':'0,10','keyCol':10,'clasDesc':'View Records','keyMas':0,'desMas':1,'recBut':'yes'};
